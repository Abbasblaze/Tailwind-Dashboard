      ...
      <div className="bg-white">
        <div className="flex flex-col md:flex-row justify-center items-center h-screen">
          <img
            ...
            alt=""
            className="hidden md:block mr-48 rounded-lg"
          />
          <div className="p-8 rounded w-full max-w-md">
            ...
            <div className="mt-6">
              <button className="w-full bg-gray-100 text-black py-2 rounded flex items-center justify-center mb-2 hover:bg-gray-200 transition duration-300">
                <img
              ...
              <button className="w-full bg-gray-100 text-black py-2 rounded flex items-center justify-center hover:bg-gray-200 transition duration-300">
                <img
